...
public class AuthJWTController {
    ...
    public ResponseEntity<?> registerUser(@RequestBody SignUpDto signUpDto) {
        try {
            logger.info("New User is trying to sign up our application with account: {}", signUpDto.getAccount());
            ...
            // Get role safely with proper error handling
            Role role;
            Optional<Role> adminRoleOptional = null;
            Optional<Role> userRoleOptional = null;

            if (signUpDto.getAccount().contains("chuwa")) {
                adminRoleOptional = roleRepository.findByName("ROLE_ADMIN");
                ...
                userRoleOptional = roleRepository.findByName("ROLE_USER");
                if (userRoleOptional.isPresent()) {
                    role = userRoleOptional.get();
                } else {
            ...
            logger.info("User registered successfully with account: {}", signUpDto.getAccount());
